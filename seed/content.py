...
BOARD: list[dict[str, Any]] = [
    {
        ...
        "degree": {"en": "Doctor of Economics (DSc)", "uz": "Iqtisodiyot fanlari doktori (DSc)", "ru": "Доктор экономических наук (DSc)"},
        "title": {"en": "Professor", "uz": "Professor", "ru": "Профессор"},
        "affiliation": {"en": "Institute of Economic Research, Tashkent", "uz": "Iqtisodiy tadqiqotlar instituti, Toshkent", "ru": "Институт экономических исследований, Ташкент"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0001",
        "email": "eic@algorithm-journal.uz",
        "expertise": {"en": "Macroeconomic policy, structural reform, transition economies", "uz": "Makroiqtisodiy siyosat, tarkibiy islohotlar, oʻtish iqtisodiyoti", "ru": "Макроэкономическая политика, структурные реформы, переходные экономики"},
        "order": 1,
    },
    {
        "role": "deputy_editor",
        ...
        "degree": {"en": "Doctor of Economics (DSc)", "uz": "Iqtisodiyot fanlari doktori (DSc)", "ru": "Доктор экономических наук (DSc)"},
        "title": {"en": "Professor", "uz": "Professor", "ru": "Профессор"},
        "affiliation": {"en": "University of Economics and Finance, Samarkand", "uz": "Iqtisodiyot va moliya universiteti, Samarqand", "ru": "Университет экономики и финансов, Самарканд"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0002",
        "expertise": {"en": "Public finance, taxation, fiscal decentralisation", "uz": "Davlat moliyasi, soliqlar, fiskal markazsizlashtirish", "ru": "Государственные финансы, налоги, фискальная децентрализация"},
        "order": 2,
    },
    {
        "role": "deputy_editor",
        ...
        "degree": {"en": "Doctor of Economics (DSc)", "uz": "Iqtisodiyot fanlari doktori (DSc)", "ru": "Доктор экономических наук (DSc)"},
        "title": {"en": "Professor", "uz": "Professor", "ru": "Профессор"},
        "affiliation": {"en": "Graduate School of Economics, Almaty", "uz": "Iqtisodiyot oliy maktabi, Almati", "ru": "Высшая школа экономики, Алматы"},
        "country": "KZ",
        "orcid": "0000-0002-0000-0003",
        "expertise": {"en": "International trade, regional integration, gravity models", "uz": "Xalqaro savdo, mintaqaviy integratsiya, gravitatsion modellar", "ru": "Международная торговля, региональная интеграция, гравитационные модели"},
        "order": 3,
    },
    {
        "role": "managing_editor",
        "name": "DEMO — replace: Dr Kamola Yusupova",
        "degree": {"en": "PhD in Economics", "uz": "Iqtisodiyot boʻyicha falsafa doktori (PhD)", "ru": "PhD по экономике"},
        "title": {"en": "Associate Professor", "uz": "Dotsent", "ru": "Доцент"},
        "affiliation": {"en": "Institute of Economic Research, Tashkent", "uz": "Iqtisodiy tadqiqotlar instituti, Toshkent", "ru": "Институт экономических исследований, Ташкент"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0004",
        "email": "editor@algorithm-journal.uz",
        "expertise": {"en": "Editorial management, research methodology", "uz": "Tahririy boshqaruv, tadqiqot metodologiyasi", "ru": "Редакционное управление, методология исследований"},
        "order": 4,
    },
    {
        "role": "section_editor",
        ...
        "degree": {"en": "PhD in Economics", "uz": "Iqtisodiyot boʻyicha falsafa doktori (PhD)", "ru": "PhD по экономике"},
        "title": {"en": "Associate Professor", "uz": "Dotsent", "ru": "Доцент"},
        "affiliation": {"en": "Banking and Finance Academy, Tashkent", "uz": "Bank-moliya akademiyasi, Toshkent", "ru": "Банковско-финансовая академия, Ташкент"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0005",
        "expertise": {"en": "Banking regulation, financial inclusion, credit markets", "uz": "Bank tartibga solish, moliyaviy qamrov, kredit bozorlari", "ru": "Банковское регулирование, финансовая доступность, кредитные рынки"},
        "order": 5,
    ...
    },
    {
        ...
        "affiliation": {"en": "Warsaw School of Economics", "uz": "Varshava iqtisodiyot maktabi", "ru": "Варшавская школа экономики"},
        "country": "PL",
        "orcid": "0000-0002-0000-0006",
        "expertise": {"en": "Digital economy, platform markets, applied microeconometrics", "uz": "Raqamli iqtisodiyot, platforma bozorlari, amaliy mikroekonometrika", "ru": "Цифровая экономика, платформенные рынки, прикладная микроэконометрика"},
        "order": 6,
    ...
    },
    {
        ...
        "degree": {"en": "Doctor of Economics (DSc)", "uz": "Iqtisodiyot fanlari doktori (DSc)", "ru": "Доктор экономических наук (DSc)"},
        "title": {"en": "Professor", "uz": "Professor", "ru": "Профессор"},
        "affiliation": {"en": "National University, Tashkent", "uz": "Milliy universitet, Toshkent", "ru": "Национальный университет, Ташкент"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0007",
        "expertise": {"en": "Labour economics, migration, human capital", "uz": "Mehnat iqtisodiyoti, migratsiya, inson kapitali", "ru": "Экономика труда, миграция, человеческий капитал"},
        "order": 7,
    },
    {
        "role": "board_member",
        ...
        "degree": {"en": "PhD in Economics", "uz": "Iqtisodiyot boʻyicha falsafa doktori (PhD)", "ru": "PhD по экономике"},
        "title": {"en": "Associate Professor", "uz": "Dotsent", "ru": "Доцент"},
        "affiliation": {"en": "Middle East Technical University, Ankara", "uz": "Yaqin Sharq texnika universiteti, Anqara", "ru": "Ближневосточный технический университет, Анкара"},
        "country": "TR",
        "orcid": "0000-0002-0000-0008",
        "expertise": {"en": "Monetary policy, inflation dynamics, emerging markets", "uz": "Pul-kredit siyosati, inflyatsiya dinamikasi, rivojlanayotgan bozorlar", "ru": "Денежно-кредитная политика, динамика инфляции, развивающиеся рынки"},
        "order": 8,
    },
    {
        "role": "board_member",
        ...
        "degree": {"en": "PhD in Economics", "uz": "Iqtisodiyot boʻyicha falsafa doktori (PhD)", "ru": "PhD по экономике"},
        "title": {"en": "Senior Researcher", "uz": "Katta ilmiy xodim", "ru": "Старший научный сотрудник"},
        "affiliation": {"en": "Centre for Regional Studies, Bukhara", "uz": "Hududiy tadqiqotlar markazi, Buxoro", "ru": "Центр региональных исследований, Бухара"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0009",
        "expertise": {"en": "Regional development, agriculture, water economics", "uz": "Hududiy rivojlanish, qishloq xoʻjaligi, suv iqtisodiyoti", "ru": "Региональное развитие, сельское хозяйство, экономика водных ресурсов"},
        "order": 9,
    },
    {
        "role": "advisory",
        ...
        "degree": {"en": "PhD in Economics", "uz": "Iqtisodiyot boʻyicha falsafa doktori (PhD)", "ru": "PhD по экономике"},
        "title": {"en": "Professor Emeritus", "uz": "Faxriy professor", "ru": "Заслуженный профессор"},
        "affiliation": {"en": "University of Manchester", "uz": "Manchester universiteti", "ru": "Манчестерский университет"},
        "country": "GB",
        "orcid": "0000-0002-0000-0010",
        "expertise": {"en": "Development economics, programme evaluation", "uz": "Rivojlanish iqtisodiyoti, dasturlarni baholash", "ru": "Экономика развития, оценка программ"},
        "order": 10,
    },
    {
        "role": "advisory",
        "name": "DEMO — replace: Prof. Hiroshi Tanaka",
        "degree": {"en": "Doctor of Economics", "uz": "Iqtisodiyot fanlari doktori", "ru": "Доктор экономических наук"},
        "title": {"en": "Professor", "uz": "Professor", "ru": "Профессор"},
        "affiliation": {"en": "Hitotsubashi University, Tokyo", "uz": "Hitotsubashi universiteti, Tokio", "ru": "Университет Хитоцубаси, Токио"},
        "country": "JP",
        "orcid": "0000-0002-0000-0011",
        "expertise": {"en": "Trade policy, global value chains, industrial organisation", "uz": "Savdo siyosati, global qiymat zanjirlari, tarmoq iqtisodiyoti", "ru": "Торговая политика, глобальные цепочки создания стоимости, отраслевая организация"},
        "order": 11,
    },
    {
        "role": "reviewer_board",
        ...
        "degree": {"en": "PhD in Economics", "uz": "Iqtisodiyot boʻyicha falsafa doktori (PhD)", "ru": "PhD по экономике"},
        "title": {"en": "Associate Professor", "uz": "Dotsent", "ru": "Доцент"},
        "affiliation": {"en": "Institute of Forecasting and Macroeconomic Research, Tashkent", "uz": "Prognozlashtirish va makroiqtisodiy tadqiqotlar instituti, Toshkent", "ru": "Институт прогнозирования и макроэкономических исследований, Ташкент"},
        "country": "UZ",
        "orcid": "0000-0002-0000-0012",
        "expertise": {"en": "Applied econometrics, panel data, firm-level analysis", "uz": "Amaliy ekonometrika, panel maʼlumotlar, korxona darajasidagi tahlil", "ru": "Прикладная эконометрика, панельные данные, анализ на уровне фирм"},
        "order": 12,
    },
]
