...
from apps.core import views_pages
...
urlpatterns = [
    ...
    path("about/aims-and-scope/", views_pages.named_page, {"slug": "aims-and-scope"}, name="aims_and_scope"),
    path("about/peer-review/", views_pages.named_page, {"slug": "peer-review"}, name="peer_review"),
    path("about/publication-ethics/", views_pages.named_page, {"slug": "publication-ethics"}, name="publication_ethics"),
    ...
    path("for-authors/guidelines/", views_pages.named_page, {"slug": "author-guidelines"}, name="author_guidelines"),
